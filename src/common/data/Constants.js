...
export const githubAppLicenseLink = githubAppRepoLink + "/blob/develop/LICENSE";
export const githubAppIssueLink = githubAppRepoLink + "/issues";
export const githubAppUserManLink = githubAppRepoLink + "/wiki/User-Manual:-Introduction";
export const githubAppDevManLink = githubAppRepoLink + "/wiki/Developer-Manual:-Introduction";
