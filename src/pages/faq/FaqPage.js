    ...
    <div className="faq-root">
      <div className="container">
        ...
        <div className="faq-body">
          ...
          <p>
            Unigram is 
            a <a href="https://docs.microsoft.com/en-us/windows/uwp/get-started/whats-a-uwp"> 
            Universal Windows Platform (UWP)</a> application, the official Telegram clients 
            for Windows and Windows Mobile are not.
          </p>
          <p>
          ...
          <hr/>
          <p>
            Unigram is a contraction between <i>Universal</i> since our app is UWP 
            and <i>Telegram</i> which is the underlying service. Do not confuse it with 
