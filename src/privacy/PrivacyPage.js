      ...
      <div className="container">
        <div className="privacy-heading">
          ...
          <p className="text-muted sh2">
            ...
            project. Anyone can study 
            our <a href="https://github.com/UnigramDev/Unigram">Source Code</a> and 
        ...
        <div className="privacy-body">
          ...
          <hr/>
          <p>
            Unigram makes use of the <a href="https://telegram.org/">Telegram</a> service. 
            If you choose to use this application, you should familiarize yourself 
